...
// Test cases:
console.log(toFreud("")); // should return ""
console.log(toFreud("test")); // should return "sex"
console.log(toFreud("This is a test")); // should return "sex sex sex sex"
console.log(toFreud("This is a longer test")); // should return "sex sex sex sex sex"
console.log(toFreud("You're becoming a true freudian expert")); // should return "sex sex sex sex sex sex"
